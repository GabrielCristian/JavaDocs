...
public class Student {
    ...
    public boolean equals(Object o) {
        ...
        if(id == student.id && lastName.equals(student.lastName) && firstName.equals(student.firstName) && averageGrade.equals(student.averageGrade)) {
            return true;
        }
        else {
            return false;
    ...
    public int hashCode() {
        ...
        return id*1000 + firstName.hashCode()*100 + lastName.hashCode()*10 + averageGrade.hashCode();
    }
