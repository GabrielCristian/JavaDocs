...
public class Exercise1 {
    ...
    public List<String> iteratingOverEntries(){
        ...
        for ( HashMap.Entry<String, String> s : countries.entrySet()) {

                if(s.getKey().contains("Q") || s.getKey().contains("q"));
                    seekingCountries.add(s.getKey().toLowerCase());
